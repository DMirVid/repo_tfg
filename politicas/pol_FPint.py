## Política de asignación de cores que estima si una aplicación es de coma flotante, estas se ejecutan en el núcleo P.
## Las aplicaciones de 2006 no podían ser detectadas por culpa de su compilación.
## Daniel Mirón
