...
## Scrip para obtener la energía de las aplicaciones cuando se ejecutan varias intancias de la misma.
## Para sacar un promedio del consumo con varios núcleos en ejecución con la misma aplicación.
## Daniel Mirón
